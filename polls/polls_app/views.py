...
class IndexView(generic.ListView):
    ...
    def get_queryset(self):
        """Return the last 5 published questions (not 
        including those published in the future)."""
...
def vote(request, question_id):
    ...
    try:
        ...
        return HttpResponseRedirect(reverse('polls_app:results', args=(question_id,)))
